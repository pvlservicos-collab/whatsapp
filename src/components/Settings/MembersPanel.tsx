...
import { Plus, MagnifyingGlass, DotsThree, Trash, Plugs, ShieldStar } from '@phosphor-icons/react'
    ...
    if (loading) {
        return (
            <div className="flex justify-center py-20">
                <LoadingSpinner text="Carregando membros..." size="lg" />
            </div>
        )
    }
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center justify-center gap-2 text-sm font-semibold transition-colors shadow-sm"
                >
                    <Plus weight="bold" />
                    Novo Membro
                </button>
                                    ...
                                    <tr key={member.id} className="hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-gray-100 border border-gray-200 text-gray-700 font-medium">
                                                {member.organization_roles?.name === 'Administrador' ? (
                                                    <ShieldStar weight="fill" className="text-amber-500" />
                                                ) : null}
