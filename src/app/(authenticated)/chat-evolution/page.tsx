...
export default function ChatEvolutionPage() {
  ...
  // Trava a seleção inicial num lead concreto, pra não "seguir" a reordenação
  // por atividade recente sempre que qualquer admin mandar mensagem em
  // qualquer lead (bug: conversa troca sozinha).
